...
namespace Visual_Media_Organizer
{
    public partial class HotKeyForm : Form
    {
        ...
        public Keys UnsaveKey { get; private set; }
        ...
        private void btnUnsaveChange_Click(object sender, EventArgs e)
        {
            StartListening();
        }
            ...
            try
            {
                ...
                if (File.Exists(configFilePath))
                {
                    ...
                    if (keybinds != null)
                    {
                        ...
                        UnsaveKey = keybinds.UnsaveKey;
                        txtboxUnsaveKeybind.Text = UnsaveKey.ToString();
                    }
                }
                else
                {
        ...
        private void HotKeyForm_KeyDown(object sender, KeyEventArgs e)
        {
            if (listeningForKey)
            {
                ...
                else if (btnUnsaveChange.Focused)
                {
                    txtboxUnsaveKeybind.Text = e.KeyCode.ToString();
                    UnsaveKey = e.KeyCode;
                }
    ...
    public class Keybinds
    {
        ...
        public Keys UnsaveKey { get; set; } = Keys.None;
    }
}