namespace Visual_Media_Organizer
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBoxOrgType.Items.AddRange(new object[] { "Date Modified (New->Old)", "Date Modified (Old->New)", "Name (A->Z)", "Name (Z->A)", "Random" });
            comboBoxOrgType.Location = new Point(801, 654);
            comboBoxOrgType.Name = "comboBoxOrgType";
            comboBoxOrgType.Size = new Size(163, 23);
            ...
            lblOrganizeType.Location = new Point(841, 637);
            ...
            btnRefresh.Location = new Point(741, 654);
